# encoding: utf-8
# module lazy_object_proxy.cext
# from /usr/local/lib/python2.7/site-packages/lazy_object_proxy/cext.so
# by generator 1.137
# no doc
# no imports
...
def identity(*args, **kwargs): # real signature unknown
    """ Indentity function: returns the single argument. """
    pass
...
class Proxy(object):
    ...
    __factory__ = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
